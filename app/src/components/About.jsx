        ...
        <div className="grid lg:grid-cols-5 gap-12">
          <div className="lg:col-span-3">
            {about.paragraphs.map((p, i) => (
              <p key={i} className="text-[var(--color-text-soft)] leading-relaxed mb-4" dangerouslySetInnerHTML={{ __html: p.replace('{yearsExperience}', hero.yearsExperience) }} />
            ))}

            <div className="grid sm:grid-cols-2 gap-4 mt-8">
              <div className="flex items-start gap-3 p-4 rounded-xl bg-[var(--color-bg-card)] border border-[var(--color-border)]">
              ...
              <div className="flex items-start gap-3 p-4 rounded-xl bg-[var(--color-bg-card)] border border-[var(--color-border)]">
                ...
                <div>
                  ...
                  <div className="text-sm font-medium">{hero.yearsExperience}+ years in Software Engineering</div>
                </div>
              </div>
              <div className="flex items-start gap-3 p-4 rounded-xl bg-[var(--color-bg-card)] border border-[var(--color-border)]">
          ...
          <div className="lg:col-span-2 space-y-4">
            {about.highlights.map((h, i) => (
              <div key={i} className="flex items-start gap-4 p-4 rounded-xl bg-[var(--color-bg-card)] border border-[var(--color-border)]">
